...
export const TargetedAudience: React.FC = () => {
  ...
  const dropdownOptions: DropdownOptions = {
    ...
    religiousGroup: ['Christian', 'Muslim', 'Jewish', 'Hindu', 'Buddhist', 'Other', 'Non-religious', 'All Religious Groups'],
    incomeLevel: ['Under $25k', '$25k-$50k', '$50k-$75k', '$75k-$100k', '$100k-$150k', '$150k+', 'All Income Levels']
  };
  ...
  const DropdownField: React.FC<DropdownFieldProps> = ({ label, field, value }) => (
  ...
  return (
    <div>
      {/* Header */}
      <div>
        <p className="text-[16px] font-normal text-[#374151FF]">Who's Targeted audience? </p>
      </div>
